...
The purpose of this report is to draw a clear picture on Ontario citizens' responses with different income levels towards the three policies in order to make great supports and help on further development of the party in following steps. Given the situation of the present pandemic, it is crucial that the liberal party knows the real needs of society and would be able to help our people.  
<font>
...
b) Based on the simulation of the data we collected in September, a prediction of population support rate on the Liberal Party in the real world.


We used simple random sampling in this question. As figure 1.1 shows, based on the data we collected from April to August, around 39% of Ontario citizens supported the Liberal Party. Yet around 40% of people were not supporting the party and the rest of 21% of citizens did not care. Notice that the majority of people who voted "NO" could be supporters of the Conservative Party and people who voted "I don't care." could be supporting other parties or having no political leanings.

As for figure 1.2, we simulated the data by 100000 times based on our collected data in September. We took the method of simple random sampling to simulate and predict the results. It is noticeable that the support rate has increased by 2%. As the against rate almost stays the same, the number of people voting "I don't care." decreased by 3%. This implies that we could predict the Liberal Party is gaining supports among society. Moreover, we could predict the real support rate on Liberal Party among the population is around 41% to 43% with 95% of confidence (calculated with mean which is an unbiased estimate). This could be relevant to the lately released policies and we will further discuss this topic in the following paragraph.
...
Figure 4.2 shows whether people support the National Pharmacare system with regards to different income group. One major find here is that the general supportive view that is shared across different income levels. Every income groups show at least 70% of support to the policy. However, there are still differences in opinion among the 3 income groups. The support for the National Pharmacare system peaked at around 88% from the response we collect lower income group and the middle income group share a similar view with an 85% support rate. The high income group, through showing positive feelings about the idea of a National Pharmacare system, have a support rate at around 75% which is almost 10% lower than that of the middle income group. They also show the highest disapproval rate of the National Pharmacare system at around 17% in comparison to the single digit disapproval rate of the National Pharmacare system from the other 2 income group.
